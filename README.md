React Routing Assignment Project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).

Below you will find some on how to perform common tasks.<br>
